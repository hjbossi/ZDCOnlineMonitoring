...
options.register('runInputDir',
        #raw data directory like this
		#'/eos/cms/tier0/store/data/Run2023F/SpecialRandom1/RAW/v1/000/',

        #streamer directory like this
...
options.register('rawTag',
		...
		VarParsing.VarParsing.multiplicity.singleton,
		VarParsing.VarParsing.varType.string,
		"RAW input tag. Can be either rawDataCollector, or rawDataRepacker, or rawDataReducedFormat, or virginRawDataRepacker or rawPrimeDataRepacker")
...
process.es_ascii = cms.ESSource(
    ...
    input = cms.VPSet(
        cms.PSet(
            ...
            file = cms.FileInPath("OfflineProducer/QWNtrkOfflineProducer-ZDC2022/run2021/emap_2023_newZDC.txt")
...
process.zdcdigi.SOI = cms.untracked.int32(3)
...
process.TFileService = cms.Service("TFileService",
		...
		fileName = cms.string('/eos/user/j/jbistany/zdc_'+runNumber+options.outputTag+'.root')
		)
...
process.output = cms.OutputModule(
		...
		SelectEvents = cms.untracked.PSet(
			SelectEvents = cms.vstring('digiPath')
                                         ...
                                         #CHANGE THIS TO YOUR DIRECTORY
		fileName = cms.untracked.string('/eos/user/j/jbistany/digisRAW_'+runNumber+'.root')
		)
