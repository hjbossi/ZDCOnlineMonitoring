...
int plot1nPeakPerfPlot2024(
	char const *input = "/eos/cms/store/group/phys_heavyions/hbossi/ZDC2024/PbPbSamples/Run388091/") {


    gStyle->SetOptStat(0);
    gStyle->SetOptTitle(0);

    string tag = "Run388741"; 

    TLatex* cms = new TLatex(0.10,0.92,"#bf{CMS} #it{Preliminary} Run 388091");
    cms->SetNDC();
    cms->SetTextSize(0.05);
    cms->SetTextFont(42);

    TLatex* cms2 = new TLatex(0.61,0.92,"2024 PbPb (5.36 TeV)");
    cms2->SetNDC();
  ...
  for (Long64_t i = 0; i < totalEvents; i++) {
   ...
   total_plus->SetLineWidth(4);
    ...
    c3->SaveAs(Form("PerfPlot2024_%s.pdf", tag.c_str()));
