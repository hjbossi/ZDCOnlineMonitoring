void drawBananaPlotExclusive(){
    TFile* inFile = TFile::Open("BananaPlot_FSCCExclusive.root"); 
    ...
    TH2D* zdcCorrMinus = (TH2D*)inFile->Get("zdcFSCcorr_minus"); 
    TH2D* zdcCorrPlus = (TH2D*)inFile->Get("zdcFSCcorr_plus"); 
    ...
    TLatex* eventSel = new TLatex(0.3,0.16,"Exclusive Event Selection");
    eventSel->SetNDC();
    ...
    eventSel->Draw("same");  
    cms->Draw("same");
    c3->SaveAs("BananaPlotLHCC_Exclusive_ZDC.pdf");
    ...
    cms->Draw("same");
    eventSel->Draw("same"); 
    c4->SaveAs("BananaPlotFSC_Exclusive_LHCC.pdf");
    ...
    cms->Draw("same");
    eventSel->Draw("same"); 
    c5->SaveAs("BananaPlotFSCplus_Exclusive_LHCC.pdf");
    ...
    cms->Draw("same");
    eventSel->Draw("same"); 
    c6->SaveAs("BananaPlotFSCminus_Exclusive_LHCC.pdf");
    ...
    // zdc plus
    zdcCorrMinus->GetXaxis()->SetTitle("ZDC- Energy Sum (GeV)"); 
    zdcCorrMinus->GetYaxis()->SetTitle("FSC- ADC Sum "); 
    zdcCorrMinus->Draw("colz"); 
    cms->Draw("same");
    eventSel->Draw("same"); 
    c7->SaveAs("BananaPlotZDCFDCCorrMinus_Exclusive_LHCC.pdf");
    ...
    // zdc plus
    zdcCorrPlus->GetXaxis()->SetTitle("ZDC+ Energy Sum (GeV)"); 
    zdcCorrPlus->GetYaxis()->SetTitle("FSC+ ADC Sum "); 
    zdcCorrPlus->Draw("colz"); 
    cms->Draw("same");
    eventSel->Draw("same"); 
    c8->SaveAs("BananaPlotZDCFDCCorrPlus_Exclusive_LHCC.pdf");
