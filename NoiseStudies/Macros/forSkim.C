...
void forSkim(){
    ...
    chain1->SetBranchAddress("L1_Centrality_30_50_BptxAND", &cent_30_50);
        ...
        TFile* fout = new TFile(Form("/store/data/Runs_2023/skims/375259/forest_0_80_skim_375259_new%i.root", jobIdx), "recreate");
	    ...
	    //tin4->GetEntry(ievt);
            ...
            if(hiBin>0 && hiBin<160  && (ZDC_HF_MB == 1) && vertex_filter==1 && cluster_filter==1 && (abs(vz) < 15.) && coinc_filter == 1){ 
                tout->Fill();
                tout2->Fill();
                tout3->Fill();
                //tout2->Fill();
